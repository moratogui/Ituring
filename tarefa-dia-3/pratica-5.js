...
let totgorjeta =0, totsemgorjeta = 0, i =0, total, teste = 0
...
while (i < tamanho){
    ...
    totsemgorjeta = totsemgorjeta + receita[i].valor
    totgorjeta= totgorjeta + receita[i].gorjeta
    i++
}

total = totgorjeta + totsemgorjeta
console.log("O valor com gorjetas é: " + total + " e o valor sem gorjetas é: " + totsemgorjeta + " e " + teste + " vendas foram menores que R$50,00")

/* PROBLEMA 1: Qual o valor total de vendas sem gorjeta? --------------------- */
//COLOQUE SUA SOLUÇÃO AQUI: 49796


/* ----------------------------------------------------------------------------- */

/* PROBLEMA 2: Qual o valor total de vendas incluindo a gorjeta? --------------- */
//COLOQUE SUA SOLUÇÃO AQUI: 54775.6


/* ----------------------------------------------------------------------------- */

/* PROBLEMA 3: Quantas vendas foram abaixo de 50 reais? ----------------------- */
//COLOQUE SUA SOLUÇÃO AQUI: 4 vendas foram menores do que 50 reais
